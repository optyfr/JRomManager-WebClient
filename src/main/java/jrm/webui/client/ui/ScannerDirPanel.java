                ...
                new ButtonItem("tfSWDisksDestBtn") {
                    {
                        ...
                        setEndRow(false);
                        addClickHandler(
                                event -> new RemoteFileChooser("tfSWDisksDest", null, records -> setPropertyItemValue("tfSWDisksDest", "swdisks_dest_dir", records[0].path)));
                    }
                },
                ...
                new ButtonItem("tfSamplesDestBtn") {
                    {
                        ...
                        setEndRow(false);
                        addClickHandler(
                                event -> new RemoteFileChooser("tfSamplesDest", null, records -> setPropertyItemValue("tfSamplesDest", "samples_dest_dir", records[0].path)));
                    }
                },
