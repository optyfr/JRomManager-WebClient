                                ...
                                setDataSource(new RestDataSource() {
                                    {
                                        ...
                                        setOperationBindings(
                                                ...
                                                new OperationBinding() {
                                                    {
                                                        setOperationType(DSOperationType.CUSTOM);
                                                        setDataProtocol(DSProtocol.POSTXML);
                                                    }
                                                });
                                        ...
                                        setFields(nameField, parentField, fileField, verField, haveSetsField, haveRomsField, haveDisksField, createdField, scannedField,
                                                fixedField);
                                    }
                                                ...
                                                new MenuItem() {
                                                    {
                                                        ...
                                                        addClickHandler(e -> {
                                                            ...
                                                            treegrid.removeSelectedData((DSResponse dsResponse, Object data, DSRequest dsRequest) -> {
                                                                treegrid.selectSingleRecord(new Record() {
                                                                    {
                                                                ...
                                                                listgrid.setCriteria(path == null ? null : new Criteria() {
                                                                    {
                                                                        addCriteria("Parent", path);
                                                                    }
                                                                });
